...
class EfetivoCard extends StatelessWidget {
  const EfetivoCard({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: InkWell(
        onTap:()=> Navigator.push(context, MaterialPageRoute(builder: (context) => EfetivoOperacionalScreen(),)),

...
class OcorrenciasTopCard extends StatefulWidget {
  const OcorrenciasTopCard({super.key});

  @override
  State<OcorrenciasTopCard> createState() => _OcorrenciasTopCardState();
}

class _OcorrenciasTopCardState extends State<OcorrenciasTopCard> {
